 ...
 * write_port.cpp
 * 
 * IOZero32 class > write_port function test program
 *   
*/
...
{
	TestLibs::start_test("IOZero32 class > write_port()");
    ...
    for (int x = 0; x < 256; x++)
	{
        ...
        y = TestLibs::i2c_emulator_read_word_data(TestLibs::PCA9535_OUTPUTPORT0);
        if (x != y){
        ...
        y = TestLibs::i2c_emulator_read_word_data(TestLibs::PCA9535_OUTPUTPORT1);
        if (x != y){
