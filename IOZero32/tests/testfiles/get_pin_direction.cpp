 ...
 * 
 * IOZero32 class > get_pin_direction function test program
 *   
*/
...
{
	TestLibs::start_test("IOZero32 class > get_pin_direction()");
	...
	for (uint8_t a = 1; a < 17; a++){
		...
		TestLibs::i2c_emulator_write_word_data(TestLibs::PCA9535_CONFIGPORT0, y);
