...
Version 1.0 Created 01/07/2020
      ...
      compile with "g++ get_port_polarity.cpp ../ABE_IoPi.cpp -Wall -Wextra -Wpedantic -Woverflow -o get_port_polarity"
      run with "./get_port_polarity"
 
This test validates the get_port_polarity method in the IOPi class.
