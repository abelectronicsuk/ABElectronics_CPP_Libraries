...
Version 1.0 Created 01/07/2020
      ...
      compile with "g++ set_interrupt_on_bus.cpp ../ABE_IoPi.cpp -Wall -Wextra -Wpedantic -Woverflow -o set_interrupt_on_bus"
      run with "./set_interrupt_on_bus"
 
This test validates the set_interrupt_on_bus method in the IOPi class.
