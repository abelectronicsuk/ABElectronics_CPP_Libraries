...
Version 1.0 Created 01/07/2020
      ...
      compile with "g++ set_interrupt_on_port.cpp ../ABE_IoPi.cpp -Wall -Wextra -Wpedantic -Woverflow -o set_interrupt_on_port"
      run with "./set_interrupt_on_port"
 
This test validates the set_interrupt_on_port function in the IOPi class.
