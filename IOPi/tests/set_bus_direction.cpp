...
Version 1.0 Created 01/07/2020
      ...
      compile with "g++ set_bus_direction.cpp ../ABE_IoPi.cpp -Wall -Wextra -Wpedantic -Woverflow -o set_bus_direction"
      run with "./set_bus_direction"
 
This test validates the set_bus_direction method in the IOPi class.
