/*
 * rtc_set_frequency.cpp
 * 
 * ExpanderPi class > rtc_set_frequency function test program
 *   
*/
...
{
	TestLibs::start_test("ExpanderPi class > rtc_set_frequency()");
    ...
    rtc.rtc_set_frequency(1); // set frequency to 1Hz
    ...
    rtc.rtc_set_frequency(2); // set frequency to 4.096KHz
    ...
    rtc.rtc_set_frequency(3); // set frequency to 8.192KHz
    ...
    rtc.rtc_set_frequency(4); // set frequency to 32.768KHz
