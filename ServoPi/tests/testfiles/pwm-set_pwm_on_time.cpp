...
int main(int argc, char **argv) {
	...
	TestLibs::start_test("PWM class > set_pwm_on_time()");
	...
	TestLibs::test_i2c_register(TestLibs::PCA9685_LED0_ON_Low, 0x02); // LED0_ON_High expected to be 0x02
	TestLibs::test_i2c_register(TestLibs::PCA9685_LED0_ON_High, 0x08); // LED0_ON_High expected to be 0x08
	
	pwm.set_pwm_on_time(10, 0x06A4);

	TestLibs::test_i2c_register(TestLibs::PCA9685_LED0_ON_Low + 36, 0xA4); // LED9_ON_High expected to be 0xA4
	TestLibs::test_i2c_register(TestLibs::PCA9685_LED0_ON_High + 36, 0x06); // LED9_ON_High expected to be 0x06
